...
class UtilsTest(TestCase):
    ...
    def test_delete_images(self):
        ...
        # Mock all side effects and return values for the os.path module.
        self.patches[0].get_original()[0].path.abspath.return_value = f"{self.qr_dir}/{str(self.thread_id)}"
    ...
    def test_delete_pdfs(self):
        ...
        self.patches[0].get_original()[0].path.abspath.return_value = f"{self.pdf_dir}/{str(self.thread_id)}"

        try:
            utils.delete_pdfs(self.thread_id, bln_delete=True)

        except Exception:
            self.fail(msg="The method `utils.delete_pdfs` should have raised an exception.")
    ...
    def test_sort_alphanumeric_list(self):
        ...
        for unsorted_list in permutations(['hola1', 'hola2', 'ahola1', 'hola', 'aaa', 'bba']):
